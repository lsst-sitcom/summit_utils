...
from lsst.summit.utils.guiders.transformation import convert_roi, mk_roi_bboxes
...
class ReadGuiderData:
    ...
    def print_header_info(self):
        ...
        print(
            f"ROI Row: {self.roiRow}, ROI Col: {self.roiCol}, ROI Rows: {self.roiRows},"
            f" ROI Cols: {self.roiCols}"
        )
...
def get_guider_stamps(
    idet, seqNum, dayObs, repo="/repo/embargo", collections=["LSSTCam/raw/guider"], butler=None, view="dvcs"
):
    """
